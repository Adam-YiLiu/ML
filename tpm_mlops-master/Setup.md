...
### 1a. Setup (You only need to do this once)
...
### 1b. Device specific setup
Follow the platform-specific setup guides in the `docs/` directory to prepare your target device

* [Kria DPU](docs/kria/setup.md)
* [Raspberry Pi](docs/rpi/setup.md)
* [Jetson Orin](docs/jetson/setup.md)
